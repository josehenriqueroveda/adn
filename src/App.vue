<template>
  <div class="container">
    <div class="sidebar">
      <h1 class="logo blue">ADN</h1>
      <i class="material-icons hamburger" @click="isCollapsed = !isCollapsed">menu</i>
      <nav class="sidebar-links" v-if="!isCollapsed">
        <RouterLink class="sidebar-link" to="/">Home</RouterLink>
